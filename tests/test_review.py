...
def setUp(self):
    ...
    self.new_review = Review(blog_id=12345,blog_title='Review for blogs',image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",blog_review='This blog is the best thing since sliced bread',user = self.user_sheila)
